...
const de = {
    ...
    nav: {
        ...
        menu: 'Menü',
        media: 'Medien',
        switchToTasks: 'Aufgaben',
        switchToMedia: 'Medien',
    },
    task: {
        title: 'Titel',
    ...
    media: {
        ...
        typeTv: 'Serie',
        typeBook: 'Buch',
        searchPlaceholderMovie: 'Film suchen …',
        searchPlaceholderTv: 'Serie suchen …',
        ...
        emptyLibrary: 'Noch nichts in der Bibliothek.',
        watchedAt: 'Gesehen am',
        readAt: 'Gelesen am',
        byAuthor: 'von :authors',
        remove: 'Entfernen',
        removeConfirm: 'Diesen Eintrag wirklich entfernen?',
        nextEpisode: 'Nächste Folge',
        season: 'Staffel :number',
        episode: 'Folge :number',
        nothingInProgress: 'Keine neuen Folgen.',
